...
abstract class Kohana_Jam {
	...
	public static function process_class_name($class_name)
	{
		return $class_name;
	}
	...
	{
		$field = Jam::$_field_prefix.Jam::process_class_name($type);
	...
	{
		$association = Jam::$_association_prefix.Jam::process_class_name($type);
	...
	{
		$behavior = Jam::$_behavior_prefix.Jam::process_class_name($type);
	...
	{
		$rule = Jam::$_validator_rule_prefix.Jam::process_class_name($type);
	...
	public static function class_name($model)
	{
		...
		{
			return strtolower(Jam::$_model_prefix.Jam::process_class_name($model));
		}
	}
